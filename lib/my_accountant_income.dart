...
class MyApp_income extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyAccountant_income(),
    );
  }
}

class MyAccountant_income extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _MyAccountant_income();
  }
}

class _MyAccountant_income extends State<MyAccountant_income> {
...
void get_cat() async {
  ...
  Widget incomeInput(BuildContext context){
    return Column(
              children: [
              TextButton(
                  ...
                  onPressed: ()async{
                    try{
                      ...
                      if(chosenpm == null || chosencat == null || AmountController.text == '' || DescController.text == ''){
                        ...
                        try{
                          await GoolgeSheetsAPI.insert_income([income]);
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Error While Adding Income..!"),
                          ));
                        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Income"), backgroundColor: Colors.blueAccent),
        body: Container(
          padding: EdgeInsets.all(50),
          child: Center(
            child: incomeInput(context)
        )
      ),
    );
  }
